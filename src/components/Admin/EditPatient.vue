      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          <span class="user-name">
            <strong>Edit patient {{this.ssn}}</strong>
          </span>
  ...
  <main class="page-content">
    <div class="container">
      <form class="form-signin" @submit.prevent="update">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit">Update Patient</button>
      </form>
    </div>
...
export default {
  ...
  methods: {
    update () {
      axios.post('http://localhost:5000/admin/patient/edit', {'SSN': this.ssn, 'Name': this.name, 'phone': this.phone}, {headers: {'x-access-token': localStorage.adminToken}})
        .then((request) => {
