  ...
  <main class="page-content">
    <div class="container">
      <form class="form-signin" @submit.prevent="update">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit">Assign Doctor to room</button>
      </form>
    </div>
...
export default {
  ...
  methods: {
    update () {
      axios.post('http://localhost:5000/admin/DtR', {'ssn': this.ssn, 'roomno': this.roomno}, {headers: {'x-access-token': localStorage.adminToken}})
        .then((request) => {
    ...
    async getData () {
      ...
      await axios.get('http://localhost:5000/admin/DtR/get', {headers: {'x-access-token': localStorage.adminToken}}).then((res) => {
